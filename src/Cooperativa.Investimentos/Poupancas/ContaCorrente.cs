...
{
    public sealed class ContaCorrente : IValueObject
    {
        ...
        public ContaCorrente(Guid cooperativaId, Guid postoAtendimentoId, Guid contaCorrenteId, int numero, int digito)
        {
